...
const InputData = () => {
    ...
    function handleClick() {
        if (nama.trim() !== "") {
            navigate('/home', { state: { userName: nama, email: email } });   
        } else {
    ...
    return (
        <div className="bg-[#EF7721] h-[100vh] px-5 pt-10">
            ...
            <div className="bg-white absolute w-full h-50 left-0 bottom-0"></div>
            <div className="bg-white h-[75.9vh] absolute w-full left-0 rounded-tl-4xl rounded-tr-4xl p-7">
                ...
                <h1 className="text-[20px] mt-5">EMAIL</h1>
                <input onChange={(e) => setEmail(e.target.value)} type="email" className="bg-white w-full h-15 rounded-2xl outline-1 mt-3 pl-5" placeholder="input your email here" />
